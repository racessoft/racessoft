										...
										<div id="jobcardDiv"
											...
											<table class="jobcardContent" style="padding:10px 0px 0px 10px;">
												...
												<tr>
													<td>Chasis Number</td>
													<td><input 
															id="chasisNumber" name="chasisNumber" /></td><td class="mandatory">*<div id="jobcardNumberValidation"></div></td>
															<td align="center">
													<input type='submit' value='Fetch Customer Detail'
													id='fetchButton' />
												</td>
												</tr>
											</table>
