...
<body style="background: #BABABA" onload="loadCustomerDateComponents();enableordisableCustomerId();">
	<div>
		<div id="leftPanel">
			<div>
			...
			<div id="content">
				...
				<div id="mainFull">
					...
					<div>
						...
						<form:form commandName="customerDetails"
							action="updateCustomerDetails.do" onsubmit="return validateCustomerForm('updateCustomer');">
