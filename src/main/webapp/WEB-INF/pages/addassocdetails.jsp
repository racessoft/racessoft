...
<body style="background: #BABABA"
	onload="loadAssociateDateComponents();">
			...
			<div id="content">
				...
				<div id="mainFull">
					...
					<div>
						...
						<form:form commandName="employeeDetails" name="assocform">
							<table style="width: 100%" border="0" cellspacing="3"
								cellpadding="3">
								<tr>
									<td width=""><div>
											<h3 style="padding-left: 10px;">ASSOC DETAIL</h3>
										</div>
										<div id="sparesDetailDiv"
											...
											<table class="jobcardContent" cellspacing="6"
												...
												<tr>
													<td>Associate Id</td>
													<td><form:input path="employeeId" id="employeeId" onblur="checkEmployeeIdAvailability()" /></td>
													<td class="mandatory">*</td>
													<td class="mandatory" id="availabilityMessage"></td>
												</tr>
												<tr>
							...
							<div>
								<div style="float: left; padding-left: 200px;">
									<input type='button' value='Save Assoc Detail' id='saveAssoc'
										onclick="return validateAssocForm('saveAssoc')" />
								</div>
								<div style="float: left; padding-left: 15px;">
									<a href="assocReport.do?from=addAssoc"
										style="text-decoration: underline; font-weight: bold;"
										id='addAssoc'> Add Assoc Detail </a>
								</div>
							</div>
						</form:form>
					</div>
