...
<body style="background: #BABABA" onload="loadFeedBackDateComponents();enableordisableCustomerId();enableCustomerButton();">
						...
						<div id="AjaxLoadingInfo" style="display:none;padding: 5px 5px 5px 85px; float: left"><img src="./images/ajax-loader.gif"/></div>
										...
										<div id="sparesDetailDiv"
											...
											<table class="jobcardContent" cellspacing="6"
												...
												<tr>
													...
													<td><form:input path="jobcardNumber" id="jobcardNumber" onchange="validateJobCard()"/></td>
												...
												<tr>
													<td>Chasis Number</td>
													<td><form:input path="chasisNumber" id="chasisNumber" readonly="readonly"/></td>
													<td class="mandatory">*</td>
												</tr>  
												<tr>
							...
							<div>
								<div style="float: left; padding-left: 200px;">
									<input disabled="disabled" type='button' value='Save Feedback Detail' id='saveFeedback'
										onclick="return validateFeedbackForm('saveFeedback')" />
								</div>
								<div style="float: left; padding-left: 15px;">
									<a href="addfeedBackDetails.do?from=addFeedBackReport"
										style="text-decoration: underline; font-weight: bold;"
										id='addSpares'> Add Feedback Detail </a>
								</div>
							</div>
						</form:form>
					</div>
