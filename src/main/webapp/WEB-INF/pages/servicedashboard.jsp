...
<script type="text/javascript"  src="./js/servicedashboardMetrics.js"></script>
...
<body style="background: #BABABA"
	onload="getServiceDashboardMetricsOne()">
	<div>
		<div id="leftPanel">
			<div>
			...
			<div id="accordion">
				...
				<div>
					<p></p>
					<ul>
						<li><a href="viewSpares.do?navLink=leftPane&from=updateJobCardReport">View Spares Detail</a></li>
						<li><a href="viewSpares.do?navLink=leftPane&from=updateJobCardReport">View Spares Detail</a></li>
						<li><a href="viewSpares.do?navLink=leftPane&from=updateJobCardReport">View Spares Detail</a></li>
						<li><a href="viewSpares.do?navLink=leftPane&from=updateJobCardReport">View Spares Detail</a></li>
					</ul>
				...
				<div>
					<p></p>
					<ul>
						<li><a href="servicedashboard.do?navLink=leftPane&fromServiceDashboard=dashboardOne">View Service Dashboard</a></li>
						<li><a href="servicedashboard.do?navLink=leftPane&fromServiceDashboard=dashboardTwo">View Spares Detail</a></li>
						<li><a href="servicedashboard.do?navLink=leftPane&fromServiceDashboard=dashboardThree">View Spares Detail</a></li>
						<li><a href="servicedashboard.do?navLink=leftPane&fromServiceDashboard=dashboardFour">View Spares Detail</a></li>
					</ul>
				</div>
			</div>
...
<div style="float:left;">welcome <%=session.getAttribute("username")%> </div><%}%> --%>
						...
						<div id="titleDiv"
							...
							<span class="TabHead">Races Service Report Analytics Dashboard</span>
						</div>
								...
								<div id="block1"
									...
									<!--  <div id="graphDiv"
										...
										<form name="usageTrend">
											<input readonly="readonly" id="salesReportSave" name="usageTrendSave"
							...
							<td width="45%" style="padding-right: 10px;">
								<div id="block2"
									...
									<div id="graphDiv"
										style="float: left; width: 100%; height: 33px; text-align: center; padding: 10px;">
										<form name="snapshot">
											<input readonly="readonly" id="serviceReportSave" name="Submit" type="submit"
								...
								<div id="block3"
									...
									<div style="width: 98%">
										<a id="researchAreaLink"
											...
											href="getReport.do?forCurrentMonth=<%=new SimpleDateFormat("yyyy-MM-dd").format(new java.util.Date())%>&from=monthlyReport&navLink=leftPane"><strong>Report
												Analysis</strong> </a>
									</div>
								</div>
							</td>
							<td style="font-size: 16px;">
								<div style="width: 98%">
									<div id="block3"
										...
										<a id="dataEntryLink"
											style="padding-left: 42%; text-align: center;" href="customerReport.do?from=addCustomer"><strong>Data
												Entry</strong> </a>
									</div>
								</div></td>
						</tr>
