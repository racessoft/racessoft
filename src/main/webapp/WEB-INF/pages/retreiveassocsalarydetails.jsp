			...
			<div id="content">
				...
				<div id="mainFull">
					...
					<div>
						...
						<form
							action="fetchAssocSalaryDetail.do">
												 ...
												 -->
													<td><select 
															...
															<c:forEach var="EngineerName" items="${EmployeeDetails}"
																varStatus="iter">
																<option value='${EngineerName.employeeId}'
																	title='${EngineerName.employeeName}'>
																${EngineerName.employeeName}</option>
															</c:forEach>
														</select>
													</td>
													<td class="mandatory">*<div id="jobcardNumberValidation"></div></td>
													
													<td>Salary Month</td>
													<td><input 
															id="salaryMonth" name="salaryMonth" class="date-picker" /></td><td class="mandatory">*<div id="jobcardNumberValidation"></div></td>		
															<td align="center">
													<input type='submit' value='Fetch Associate Salary Detail'
													id='fetchButton' />
												</td>
												</tr> 
											</table>
