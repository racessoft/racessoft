...
<body style="background: #BABABA" onload="loadDateComponents();enableJobcardButton()">
	<div>
		<div id="leftPanel">
			<div>
				...
				<div id="mainFull">
					...
					<div>
						...
						<form:form commandName="jobCardDetails"
							...
							<div style='float: left; padding: 2px 0px 0px 5px;'>
								...
								<c:choose>
									<c:when
										...
										<div style='float: left; padding: 10px;'>
											<a
												...
												style="text-decoration: underline; font-weight: bold;pointer-events: none;"
									...
									<c:otherwise>
										<div style='float: left; padding: 10px;'>
											<a
												href="${updateFeedBackDetailsString}"
							...
							<div>
								<div class="jobcardContent"
									style="float: left; padding-left: 135px;">Total Cost:</div>
								<div style="float: left;">
									<div>
