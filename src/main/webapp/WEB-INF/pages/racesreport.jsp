		...
		<div id="leftPanel">
			...
			<div id="accordion">
				...
				<div>
					<p>
					<ul>
						<li><a href="getCustomerReport.do?navLink=leftPane&reportType=reportByDistrict&from=customerByTaluk">Data By Taluk</a>
						</li>
						<li><a
							href="getCustomerReport.do?navLink=leftPane&reportType=reportByDistrict&from=customerByDistrict">Data By District</a>
						</li>
					</ul>
					</p>
				</div>
