										...
										<div id="jobcardDiv"
											...
											<table class="jobcardContent" style="padding:10px 0px 0px 10px;">
												...
												<tr>
													<td>Associate Id</td>
													<!-- <td>
														<input id="employeeId" name="employeeId" /></td><td class="mandatory">*<div id="jobcardNumberValidation">
														</div>
													</td>
													 -->
													<td>
													<select id="employeeId" name="employeeId">
														...
														</select>	*<div id="jobcardNumberValidation">
														</div>	
														</td>	
															<td align="center">
															
													<input type='submit' value='Fetch Associate Detail'
													id='fetchButton' />
												</td>
												</tr>
											</table>
