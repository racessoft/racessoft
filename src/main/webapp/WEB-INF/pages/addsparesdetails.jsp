...
<body style="background: #BABABA">
	<!--  onload="loadCustomerDateComponents();enableordisableCustomerId();enableCustomerButton();">
	-->
	<div>
		<div id="leftPanel">
			<div>
			...
			<div id="content">
				...
				<div id="mainFull">
					...
					<div>
						...
						<form:form commandName="sparesDetails" name="sparesform">
									...
									<td width=""><div>
										...
										<div id="sparesDetailDiv"
											...
											<table class="jobcardContent" cellspacing="6"
												...
												<tr>
													<td>Minimum Order</td>
													<td><form:input path="minimumOrder" id="minimumOrder" />
													</td>
													<td class="mandatory">*</td>
												</tr>
											</table>
							...
							<div>
								<div style="float: left; padding-left: 200px;">
									<input type='button' value='Save Spares Detail' id='saveSpares'
										onclick="return validateSparesForm('saveSpares')" />
								</div>
								<div style="float: left; padding-left: 15px;">
									<a href="sparesReport.do?from=addSpares"
										style="text-decoration: underline; font-weight: bold;"
										id='addSpares'> Add Spares Detail </a>
								</div>
							</div>
						</form:form>
					</div>
