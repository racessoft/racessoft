										...
										<div id="jobcardDiv"
											...
											<table class="jobcardContent" style="padding:10px 0px 0px 10px;">
												...
												<tr>
													<td>Spares Id</td>
													<td><input 
															id="sparesCode" name="sparesCode" /></td><td class="mandatory">*<div id="jobcardNumberValidation"></div></td>
															<td align="center">
													<input type='submit' value='Fetch Spares Detail'
													id='fetchButton' />
												</td>
												</tr>
											</table>
