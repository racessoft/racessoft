										...
										<div id="jobcardDiv"
											...
											<table class="jobcardContent" style="padding:10px 0px 0px 10px;">
												...
												<tr>
													...
													<td><input 
															id="jobcardNumber" name="jobcardNumber" /></td><td class="mandatory">*<div id="jobcardNumberValidation"></div></td>
															<td align="center">
													<input type='submit' value='Fetch Feedback Detail'
													id='fetchButton' />
												</td>
												</tr>
											</table>
