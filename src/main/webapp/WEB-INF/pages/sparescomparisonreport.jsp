...
<script type="text/javascript"  src="./js/customerdetailsreport.js"></script>
<!-- 
...
<body style="background: #BABABA" onload="getGridData();getCustomerReport('DISTRICT');">
	<div>
		<div id="leftPanel">
			<div>
						...
						<form:form commandName="reportFilter" action="exportReport.do" onsubmit="if($('#exportTypeFilter').val() != 'DEFAULT'){$('#exportmessage').hide();showLoadingIcon();disableButton()};return validateReport();">
							<table style="width: 100%" border="0" cellspacing="10"
												...
												<tbody>
													...
													<tr>
														...
														<td align="center"
															...
															<input type="button" onclick="getCustomerReport('DISTRICT');"
														...
														<td align="left" valign="middle"
															...
															value=" Save Report " class="" id="savereport" onclick="downloadCustomerData();"
															name="input2" >
														</td>
														<td align="left" valign="middle"
															style="padding-left: 20px;" colspan="2">

																<label id="Customer Count" >NoOfCustomers :</label>&nbsp;&nbsp;
																<label id="noOfCustomers">0</label>
														</td>
													</tr>
												</tbody>
											</table>
								...
								<tr>
									<td width="">
										<div id="myLGrid"
											style="border-radius: 6px 6px 6px 6px; overflow-y: auto; overflow-x: hidden; float: left; width: 350px; height: 400px; border: 1px solid #ccc; text-align: center">
										</div>
										<div id="myRGrid"
											style="border-radius: 6px 6px 6px 6px; overflow-y: auto; overflow-x: hidden; float: left; width: 350px; height: 400px; border: 1px solid #ccc; text-align: center">
										</div>
