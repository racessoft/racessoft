		...
		<div id="leftPanel">
			...
			<div id="accordion">
				...
				<div>
					<p>
					<ul>
						<li><a href="#">Free Service Report</a></li>
						<li><a href="#">Particular Service Report</a></li>
					</ul>
					</p>
				</div>
				...
				<div>
					<p></p>
					<ul>
						<li><a href="#">Complete jobcard report</a></li>
					</ul>
				</div>
						...
						<div>
							<table align="center" width="100%" style="padding-top: 150px;">
								<tr>
									...
									<div style="overflow-y: auto; border: 2px solid; padding: 10px; float: left; width: 54%; height: 100px;">Exception : ${ExceptionMessage}</div>
