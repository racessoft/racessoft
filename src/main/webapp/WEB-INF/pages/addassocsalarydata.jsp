				...
				<div id="mainFull">
					...
					<!-- 
					 ...
					 -->	
						...
						<form:form commandName="salaryDetails" name="getSalaryDataForm" action="getSalaryDataEntryPage.do" onsubmit="return validateSalaryDataForm();">
						<div id="AjaxLoadingInfo" style="display:none;padding: 5px 5px 5px 85px; float: left"><img src="./images/ajax-loader.gif"/></div>
									...
									<td width=""><div>
										...
										<div id="sparesDetailDiv"
											...
											<table class="jobcardContent" cellspacing="6"
												...
												<tr>
													<td>Associate Salary</td>
													<td><form:input path="salary" id="salary" class="required"/></td> 
												</tr>
												<tr></tr>
												<tr>
													<td>As On Date</td>
							...
							<div>
								...
								<!-- 
								 ...
								 -->
								 <input type='button' value='Save Assoc Salary Detail' id='saveSalaryDetails'
										onclick="return validateSalaryDataForm('getSalaryDataForm')" />
