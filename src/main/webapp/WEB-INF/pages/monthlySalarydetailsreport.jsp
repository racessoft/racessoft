...
<body style="background: #BABABA" onload="loadSalaryDateComponents();getGridData();getCustomerReport('DISTRICT');">
	<div>
		<div id="leftPanel">
			<div>
								...
								<tr>
									<td>
										<div id="reportContentDiv"
											...
											Select Year:  <form:select id='yearData' path="yearOfSale" items="${salaryYears}" />
											</div>
											<div style="padding: 12px 5px 5px 25px; float: left">
													...
													<tr>
														...
														<td align="left" valign="middle"
															style="padding-left: 20px;" colspan="2">
																...
																<label id="Customer Count" >NoOfAssociates :</label>&nbsp;&nbsp;
