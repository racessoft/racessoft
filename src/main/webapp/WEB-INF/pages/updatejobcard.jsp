			...
			<div id="content">
				...
				<div id="mainFull">
					<div id="topBar">
						...
						<div id="titleDiv" style="text-align: center; width: 100%;">
														...
														<c:when test="${iteration.index % 2 ==  0}">
															<tr id="${iteration.index}">
																...
																${spareCostDetail.key}</form:option> --%>
																			<c:choose>
																				<c:when
																					test="${spare.spareCode == spareCostDetail.key}">
																					<form:option value='${spare.spareCode}'
																						title='${spare.cost}'>${spare.spareCode}</form:option>
																				</c:when>
																				<c:otherwise>
																					<form:option value='${spareCostDetail.key}'
																						title='${spareCostDetail.value}'>${spareCostDetail.key}</form:option>
																				</c:otherwise>
																			</c:choose>
																		</c:forEach>
																	</form:select></td>
